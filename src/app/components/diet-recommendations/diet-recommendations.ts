...
const CALENDARIO: Record<number, Planta[]> = {
  1: [
    { nombre: 'Habas',       imagen: IMG('habas.jpg'),                    consejo: 'Siembra directa, aguantan heladas suaves'              },
    { nombre: 'Guisantes',   imagen: IMG('guisantes.jpg'),                    consejo: 'Necesitan tutor, suelo húmedo y fresco'                },
    { nombre: 'Ajos',        imagen: IMG('ajo.webp'),                         consejo: 'Última oportunidad, planta los dientes a 10 cm'        },
    ...
    { nombre: 'Cebollas',    imagen: IMG('cebolla.jpg'),                    consejo: 'Semillero interior para trasplantar en abril'          },
  ],
  2: [
    ...
    { nombre: 'Habas',       imagen: IMG('habas.jpg'),                    consejo: 'Última siembra antes de la primavera'                  },
    ...
    { nombre: 'Puerros',     imagen: IMG('puerros.jpg'),                    consejo: 'Semillero interior, trasplanta en abril-mayo'          },
    { nombre: 'Cebollas',    imagen: IMG('cebolla.jpg'),                    consejo: 'Semillero para trasplantar cuando vengan los calores'  },
  ],
  3: [
    ...
    { nombre: 'Remolacha',   imagen: IMG('remolacha.jpg'),             consejo: 'Tolera el frío, riega regularmente'                    },
    ...
    { nombre: 'Puerros',     imagen: IMG('puerros.jpg'),                    consejo: 'Semillero, trasplanta en mayo cuando tengan 15 cm'     },
  ],
  4: [
    { nombre: 'Tomates',     imagen: IMG('tomate-cherry.jpg'),                consejo: 'Trasplanta en zonas sin riesgo de heladas'             },
    { nombre: 'Pepinos',     imagen: IMG('pepinos.jpg'),                       consejo: 'Semillero interior, necesitan calor para germinar'     },
    ...
    { nombre: 'Remolacha',   imagen: IMG('remolacha.jpg'),             consejo: 'Siembra directa, raíces en 70 días'                    },
    ...
    { nombre: 'Puerros',     imagen: IMG('puerros.jpg'),                    consejo: 'Trasplanta los semilleros de febrero-marzo'            },
  ...
  5: [
    ...
    { nombre: 'Pepinos',     imagen: IMG('pepinos.jpg'),                  consejo: 'Trasplanta o siembra directa, cosecha en 60 días'      },
    ...
    { nombre: 'Remolacha',   imagen: IMG('remolacha.jpg'),             consejo: 'Siembra directa, cosecha a finales de verano'          },
  ...
  6: [
    ...
    { nombre: 'Pepinos',     imagen: IMG('pepinos.jpg'),                       consejo: 'Segunda siembra, riego abundante en verano'            },
    { nombre: 'Remolacha',   imagen: IMG('remolacha.jpg'),             consejo: 'Riego frecuente para raíces tiernas en verano'         },
  ...
  7: [
    ...
    { nombre: 'Remolacha',   imagen: IMG('remolacha.jpg'),             consejo: 'Última siembra de verano, cosecha en septiembre'       },
    ...
    { nombre: 'Brócoli',     imagen: IMG('brocoli.jpg'),               consejo: 'Semillero a la sombra, trasplanta en agosto'           },
    { nombre: 'Coliflor',    imagen: IMG('coliflor.jpg'),               consejo: 'Semillero para cosecha otoñal, necesita espacio'       },
  ...
  8: [
    ...
    { nombre: 'Brócoli',     imagen: IMG('brocoli.jpg'),               consejo: 'Trasplanta semilleros de julio, cosecha en nov'        },
    { nombre: 'Coliflor',    imagen: IMG('coliflor.jpg'),               consejo: 'Trasplanta en agosto, cosecha en noviembre'            },
  ...
  9: [
    ...
    { nombre: 'Acelgas',     imagen: IMG('acelgas.jpg'),                      consejo: 'Siembra directa, muy productivas en otoño'             },
    { nombre: 'Brócoli',     imagen: IMG('brocoli.jpg'),               consejo: 'Trasplanta los semilleros de agosto al exterior'       },
  ...
  10: [
    { nombre: 'Ajos',        imagen: IMG('ajo.webp'),                         consejo: 'Octubre es el mejor mes para plantar ajos en España'   },
    { nombre: 'Habas',       imagen: IMG('habas.jpg'),                    consejo: 'Siembra directa, las heladas suaves las benefician'    },
    { nombre: 'Guisantes',   imagen: IMG('guisantes.jpg'),                    consejo: 'Siembra directa, florecen en primavera'                },
    { nombre: 'Cebollas',    imagen: IMG('cebolla.jpg'),                    consejo: 'Variedades de invierno, siembra directa'               },
  ...
  11: [
    { nombre: 'Ajos',        imagen: IMG('ajo.webp'),                         consejo: 'Todavía a tiempo, planta antes de diciembre'          },
    { nombre: 'Habas',       imagen: IMG('habas.jpg'),                    consejo: 'Mes óptimo en zona mediterránea cálida'                },
    ...
    { nombre: 'Cebollas',    imagen: IMG('cebolla.jpg'),                    consejo: 'Siembra directa de variedades de invierno tardías'     },
  ],
  12: [
    { nombre: 'Ajos',        imagen: IMG('ajo.webp'), consejo: 'Última oportunidad, antes de que la tierra se hiele'  },
    { nombre: 'Habas',       imagen: IMG('habas.jpg'),                    consejo: 'Solo en zonas sin heladas fuertes'                     },
